...
#        pulse.q1.LO = 11.002e9
        ...
        self.q3.X = single_qubit_gate_spec('qubit3_MW', 11.201e9, 100, MW_power=5, gate_name='X')
...
#        _read2 = m.add('read2', m['read12'] & m['read12_cnot1']) # q2 = 1 if odd parity in both measurements
#
#        _fix_1 = Conditional(m['read1'],
#                              None,
#                              self.q1.X2,
#                              )
#
#        _fix_2 = Conditional(m['read2'],
#                              None,
#                              self.q2.X2,
#                              )
#
#        _fix_12 = Conditional((m['read1'], m['read2']),
#                              None, # (0,0)
#                              self.q2.X2, # (0,1)
#                              self.q1.X2, # (1,0)
#                              [self.q1.X2, self.q2.X2], # (1,1)
#                              )
#
#        self.init12 = SequenceTemplate(
#                _read12,
#                self.wait(100),
#                self.q23.CNOT12,
#                self.wait(100),
...
seq.add(s.wait(1e3))
seq.add(s.q2.X, t_pulse = lp.linspace(1e2, 1e3, 10, axis=0))


# do a cnot to qubit 4
seq.add(s.wait(1e3))
seq.add(s.q23.CNOT21, t_gate = 50)
seq.add(s.wait(1e3))
seq.add(s.q34.CNOT21)
seq.add(s.wait(1e3))
seq.add(s.q45.CNOT21)
...
my_seq.play(index, release=False)
